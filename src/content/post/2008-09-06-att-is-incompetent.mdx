...
I have a residential phone line from AT&T so that I can get DSL from my very favorite ISP, {<ExternalLink href="http://sonic.net">sonic.net</ExternalLink>}.
...
So I closed that window and used my trusty {<ExternalLink href="http://agilewebsolutions.com/products/1Password">1Password</ExternalLink>}
