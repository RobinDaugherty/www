...
I used {<ExternalLink href='https://github.com/abiosoft/colima'>Colima</ExternalLink>} for a while, and that works well, as long as you remember to stop it when you're not using Docker.
...
But recently, I discovered {<ExternalLink href="https://orbstack.dev">Orbstack</ExternalLink>}.
...
It has a few {<ExternalLink href="https://docs.orbstack.dev/compare/docker-desktop">other advantages</ExternalLink>}.
Maybe give it a try.
