...
This document was created to document the serial-line protocol to control {<ExternalLink href="http://www.specorp.com/">Spectrum</ExternalLink>}
...
The software that I wrote that implements this protocol is called {<ExternalLink href="http://sourceforge.net/projects/huddle">Huddle</ExternalLink>}, which is GPL and hosted by Sourceforge.
...
<table>
	...
	<tbody>
		...
		<tr>
			...
			<td>
				All Message Centers with Visual Verification - This code will cause the
				wallboards to give a visual indication "Transmission OK" on the
				wallboard screen if the transmission frame format was received without
				error.
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				All Message Centers will first configure memory for 26 files of 150
				characters (A-Z) then execute the specified command.
			</td>
		</tr>
		<tr>
			<td>
...
<table>
	...
	<tbody>
		<tr>
			...
			<td>
				<a href="#write-text-file">Write Text File</a>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td>
				<a href="#write-special-functions">Write Special Functions</a>
			</td>
		</tr>
		<tr>
			<td>
...
<table>
	...
	<tbody>
		<tr>
			...
			<td>
				<strong>Double High</strong> Followed by '1' for on, '0' for off.
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<strong>True Descender</strong> Followed by '1' for on, '0' for off.
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<strong>Character Flash</strong> Followed by '1' for on, '0' for off.
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<strong>Double Stroke</strong> Followed by '1' for on, '0' for off.
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<strong>Double Width</strong> Followed by '1' for on, '0' for off.
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<strong>Fixed Width</strong> Followed by '1' for on, '0' for off.
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<strong>Fancy</strong> Followed by '1' for on, '0' for off.
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<strong>Wide Character</strong> enable.
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<strong>Wide Character</strong> disable.
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<strong>Full Height Fancy</strong>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<strong>Full Height Standard</strong>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<strong>Seven-High Standard</strong>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<strong>Five-High Standard</strong>
			</td>
		</tr>
		<tr>
			<td>
		...
		<tr>
			...
			<td>
				<strong>Line Position Top</strong>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<strong>Line Position Middle</strong>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<strong>Line Position Bottom</strong>
			</td>
		</tr>
		<tr>
			<td>
			...
			<td>
				<strong>Line Position Fill</strong>
			</td>
		</tr>
	</tbody>
</table>
		...
		<tr>
			...
			<td>
				...
				<ul>
					...
					<li>
						Some parameters (which are not documented). "AU" works for text
						files, "L" works for string files.
					</li>
					<li>The length of the file in four hex characters.</li>
					<li>
						For text files, "FF00". For string files, "0000". This might mean
						something, but it's undocumented.
					</li>
				</ul>
			</td>
		</tr>
